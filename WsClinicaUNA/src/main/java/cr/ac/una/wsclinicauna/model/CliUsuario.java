...
@NamedQueries({
    ...
    @NamedQuery(name = "CliUsuario.findByUsuarioClave", query = "SELECT c FROM CliUsuario c WHERE c.usuUsuario = :usuUsuario and c.usuClave = :usuClave", hints = @QueryHint(name = "eclipselink.refresh", value = "true")),
